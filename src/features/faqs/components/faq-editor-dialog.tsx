...
export function FaqEditorDialog({
  ...
  const handleSaveDraft = () => {
    form.handleSubmit((values) => {
      form.reset()
      toast.success(
        isEdit ? 'FAQ saved as draft.' : 'FAQ created as draft.',
  ...
  const confirmPublish = () => {
    ...
    toast.success(
      isEdit ? 'FAQ published successfully.' : 'FAQ created and published.',
      { description: values.question }
    )
    onOpenChange(false)
  }
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title='Publish FAQ'
        desc={`Are you sure you want to publish "${form.getValues('question')}"? All changes will be pushed to the mobile app.`}
        confirmText='Publish'
